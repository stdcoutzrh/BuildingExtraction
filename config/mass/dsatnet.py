...
weights_name = "0402-dsatnet-tiny"
weights_path = "/home/zrh/datasets/build/build_log/mass/{}".format(weights_name)
test_weights_name = weights_name
log_name = "/home/zrh/datasets/build/build_log/mass/{}".format(weights_name)
monitor = 'val_mIoU'
monitor_mode = 'max'
save_top_k = 1
save_last = True
